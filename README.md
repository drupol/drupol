...
- [FriendsOfPHP/PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) - A tool to automatically fix PHP Coding Standards issues (1 day ago)
...
- [loophp/iterators](https://github.com/loophp/iterators) ([1.6.13](https://github.com/loophp/iterators/releases/tag/1.6.13), today) - The missing PHP iterators.
- [loophp/nix-auto-changelog](https://github.com/loophp/nix-auto-changelog) ([1.0.0](https://github.com/loophp/nix-auto-changelog/releases/tag/1.0.0), today) - A Nix flake to generating changelog files based on your git tags and commit history.
- [loophp/repository-monadic-helper](https://github.com/loophp/repository-monadic-helper) ([1.0.6](https://github.com/loophp/repository-monadic-helper/releases/tag/1.0.6), 4 days ago) - Monadic Doctrine repositories helper classes and services.
