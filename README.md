...
- [Mic92/nix-update](https://github.com/Mic92/nix-update) ([0.19.2](https://github.com/Mic92/nix-update/releases/tag/0.19.2), 1 day ago) - Swiss-knife for updating nix packages.
- [MercuryTechnologies/nix-your-shell](https://github.com/MercuryTechnologies/nix-your-shell) ([v1.3.0](https://github.com/MercuryTechnologies/nix-your-shell/releases/tag/v1.3.0), 2 days ago) - A `nix` and `nix-shell` wrapper for shells other than `bash`
