...
- [psr7-sessions/storageless](https://github.com/psr7-sessions/storageless) - :mailbox_with_mail: storage-less PSR-7 session support (1 day ago)
...
- [drupol/psrcas-client-poc](https://github.com/drupol/psrcas-client-poc) - ecphp/cas-lib demo client for a bare PHP application. (2 days ago)
...
- [cycle/orm](https://github.com/cycle/orm) ([v2.3.0](https://github.com/cycle/orm/releases/tag/v2.3.0), 1 day ago) - PHP DataMapper, ORM
- [PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ([v3.16.0](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.16.0), 2 days ago) - A tool to automatically fix PHP Coding Standards issues
- [drupol/typst-document](https://github.com/drupol/typst-document) ([v21-b3240f1](https://github.com/drupol/typst-document/releases/tag/v21-b3240f1), 2 days ago) - A starter repository for writing documents with Typst using Nix
- [ecphp/cas-lib](https://github.com/ecphp/cas-lib) ([2.0.6](https://github.com/ecphp/cas-lib/releases/tag/2.0.6), 3 days ago) - CAS Lib, a standard library for CAS authentication.
- [vimeo/psalm](https://github.com/vimeo/psalm) ([5.9.0](https://github.com/vimeo/psalm/releases/tag/5.9.0), 5 days ago) - A static analysis tool for finding errors in PHP applications
- [flow-php/flow](https://github.com/flow-php/flow) ([0.2.6](https://github.com/flow-php/flow/releases/tag/0.2.6), 6 days ago) - Monorepo for Flow PHP - Unified data processing library
