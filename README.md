...
- [drupol/fizzbuzz](https://github.com/drupol/fizzbuzz) -  (3 days ago)
...
- [bdhave/vault4summon](https://github.com/bdhave/vault4summon) - this project implement a CyberArk Summon provider using Hashicorp Vault as secrets provider (5 days ago)
...
- [phpro/grumphp](https://github.com/phpro/grumphp) ([v1.9.0](https://github.com/phpro/grumphp/releases/tag/v1.9.0), 2 days ago) - A PHP code-quality tool
- [FriendsOfPHP/PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ([v3.7.0](https://github.com/FriendsOfPHP/PHP-CS-Fixer/releases/tag/v3.7.0), 5 days ago) - A tool to automatically fix PHP Coding Standards issues
- [phpbench/phpbench](https://github.com/phpbench/phpbench) ([1.2.5](https://github.com/phpbench/phpbench/releases/tag/1.2.5), 6 days ago) - PHP Benchmarking framework
...
- [loophp/repository-monadic-helper](https://github.com/loophp/repository-monadic-helper) ([1.0.2](https://github.com/loophp/repository-monadic-helper/releases/tag/1.0.2), 4 weeks ago) - Monadic Doctrine repositories helper classes and services.
...
- [loophp/service-alias-autoregister-bundle](https://github.com/loophp/service-alias-autoregister-bundle) ([1.0.0](https://github.com/loophp/service-alias-autoregister-bundle/releases/tag/1.0.0), 1 month ago) - Auto register services aliases in the Symfony container.
