...
- [jbuchermn/guacamole-nixos](https://github.com/jbuchermn/guacamole-nixos) - Nix flake for Apache guacamole (3 days ago)
...
- [phpDocumentor/phpDocumentor](https://github.com/phpDocumentor/phpDocumentor) - Documentation Generator for PHP  (5 days ago)

#### 🔭 Latest releases I've contributed to

- [drupol/typst-gallery](https://github.com/drupol/typst-gallery) ([v8-611e145](https://github.com/drupol/typst-gallery/releases/tag/v8-611e145), today) - 
- [Mic92/nix-update](https://github.com/Mic92/nix-update) ([0.18.0](https://github.com/Mic92/nix-update/releases/tag/0.18.0), 5 days ago) - Swiss-knife for updating nix packages.
