...
- [php-rust-tools/parser](https://github.com/php-rust-tools/parser) - A handwritten fault-tolerant, recursive-descent parser for PHP written in Rust. (1 day ago)
- [drupol/latex-letter](https://github.com/drupol/latex-letter) -  (1 day ago)
- [benedictdudel/pandoc-letter-din5008](https://github.com/benedictdudel/pandoc-letter-din5008) - Pandoc template for writing Markdown letters (DIN 5008) (2 days ago)
...
- [drupol/latex-letter](https://github.com/drupol/latex-letter) ([v31-1adda2f](https://github.com/drupol/latex-letter/releases/tag/v31-1adda2f), 1 day ago) - 
- [open-pdf-sign/open-pdf-sign](https://github.com/open-pdf-sign/open-pdf-sign) ([v0.1.1](https://github.com/open-pdf-sign/open-pdf-sign/releases/tag/v0.1.1), 1 day ago) - Digitally sign PDF files from your commandline
- [ecphp/session--composition-and-inheritance](https://github.com/ecphp/session--composition-and-inheritance) ([v40-5bf2618](https://github.com/ecphp/session--composition-and-inheritance/releases/tag/v40-5bf2618), 4 days ago) - Session &#39;Composition and inheritance&#39;
- [loophp/phposinfo](https://github.com/loophp/phposinfo) ([1.8.0](https://github.com/loophp/phposinfo/releases/tag/1.8.0), 5 days ago) - Try to guess the host operating system.
- [vimeo/psalm](https://github.com/vimeo/psalm) ([5.4.0](https://github.com/vimeo/psalm/releases/tag/5.4.0), 6 days ago) - A static analysis tool for finding errors in PHP applications
