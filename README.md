...
- [loophp/phptree-ast-generator](https://github.com/loophp/phptree-ast-generator) - Generates Abstrax Syntax Tree (AST) of a PHP script in DOT (Graphviz) or Image (PNG, JPG, SVG) formats. (4 days ago)

#### 🔭 Latest releases I've contributed to

- [vimeo/psalm](https://github.com/vimeo/psalm) ([5.0.0-rc1](https://github.com/vimeo/psalm/releases/tag/5.0.0-rc1), 1 day ago) - A static analysis tool for finding errors in PHP applications
- [doctrine/persistence](https://github.com/doctrine/persistence) ([3.1.0](https://github.com/doctrine/persistence/releases/tag/3.1.0), 6 days ago) - The Doctrine Persistence project is a library that provides common abstractions for object mapper persistence.
- [ecphp/session--nix-at-european-commission--summer-of-nix](https://github.com/ecphp/session--nix-at-european-commission--summer-of-nix) ([v9-50e92e2](https://github.com/ecphp/session--nix-at-european-commission--summer-of-nix/releases/tag/v9-50e92e2), 6 days ago) - Mirror repository - Session &#39;State of Nix at European Commission&#39; for the Summer of Nix 2022
