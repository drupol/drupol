...
- [vimeo/psalm](https://github.com/vimeo/psalm) ([4.21.0](https://github.com/vimeo/psalm/releases/tag/4.21.0), 5 days ago) - A static analysis tool for finding errors in PHP applications
