...
- [Champs-Libres/wopi-bundle](https://github.com/Champs-Libres/wopi-bundle) -  (today)
...
- [loophp/unaltered-psr-http-message-bridge-bundle](https://github.com/loophp/unaltered-psr-http-message-bridge-bundle) ([2.0.0](https://github.com/loophp/unaltered-psr-http-message-bridge-bundle/releases/tag/2.0.0), today) - Provide a PSR HTTP message bridge without altering query parameters.
...
- [ecphp/ecas](https://github.com/ecphp/ecas) ([2.1.1](https://github.com/ecphp/ecas/releases/tag/2.1.1), 2 weeks ago) - CAS library to communicate with eCAS/EULogin
