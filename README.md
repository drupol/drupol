...
- [NixOS/nix.dev](https://github.com/NixOS/nix.dev) - An opinionated guide for developers wanting to get things done with the Nix ecosystem. (3 days ago)
...
- [ecphp/cas-bundle](https://github.com/ecphp/cas-bundle) ([2.4.4](https://github.com/ecphp/cas-bundle/releases/tag/2.4.4), today) - CAS Bundle, a standard Symfony bundle for authentication using CAS protocol.
...
- [ecphp/cas-lib](https://github.com/ecphp/cas-lib) ([2.0.5](https://github.com/ecphp/cas-lib/releases/tag/2.0.5), 5 days ago) - CAS Lib, a standard library for CAS authentication.
