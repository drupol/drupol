...
- [ecphp/cas-lib](https://github.com/ecphp/cas-lib) ([2.0.3](https://github.com/ecphp/cas-lib/releases/tag/2.0.3), 2 days ago) - CAS Lib, a standard library for CAS authentication.
- [PHP-CS-Fixer/PHP-CS-Fixer](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer) ([v3.14.3](https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/tag/v3.14.3), 2 days ago) - A tool to automatically fix PHP Coding Standards issues
- [Mic92/nix-update](https://github.com/Mic92/nix-update) ([0.15.0](https://github.com/Mic92/nix-update/releases/tag/0.15.0), 4 days ago) - Swiss-knife for updating nix packages.
