...
- [NixOS/nix.dev](https://github.com/NixOS/nix.dev) - An opinionated guide for developers wanting to get things done with the Nix ecosystem. (2 days ago)
...
- [ecphp/cas-lib](https://github.com/ecphp/cas-lib) ([2.0.5](https://github.com/ecphp/cas-lib/releases/tag/2.0.5), 4 days ago) - CAS Lib, a standard library for CAS authentication.
...
- [ecphp/eu-login-bundle](https://github.com/ecphp/eu-login-bundle) ([2.4.1](https://github.com/ecphp/eu-login-bundle/releases/tag/2.4.1), 2 weeks ago) - EU Login bundle, a standard Symfony bundle to authenticate users against EU Login.
- [cycle/orm](https://github.com/cycle/orm) ([v2.2.2](https://github.com/cycle/orm/releases/tag/v2.2.2), 2 weeks ago) - PHP DataMapper, ORM
- [ecphp/ecas](https://github.com/ecphp/ecas) ([3.0.1](https://github.com/ecphp/ecas/releases/tag/3.0.1), 2 weeks ago) - CAS library to communicate with eCAS/EULogin
