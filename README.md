...
- [drupol/cas-bundle-demo](https://github.com/drupol/cas-bundle-demo) -  (4 days ago)
...
- [Innmind/Doctrine](https://github.com/Innmind/Doctrine) ([2.0.0](https://github.com/Innmind/Doctrine/releases/tag/2.0.0), 4 days ago) - Declarative approach to eliminate state where not necessary
- [phpro/grumphp](https://github.com/phpro/grumphp) ([v1.11.0](https://github.com/phpro/grumphp/releases/tag/v1.11.0), 5 days ago) - A PHP code-quality tool
- [doctrine/persistence](https://github.com/doctrine/persistence) ([3.0.0](https://github.com/doctrine/persistence/releases/tag/3.0.0), 5 days ago) - The Doctrine Persistence project is a library that provides common abstractions for object mapper persistence.
- [loophp/psr17](https://github.com/loophp/psr17) ([1.0.2](https://github.com/loophp/psr17/releases/tag/1.0.2), 6 days ago) - Provides a PSR17 synthetic implementation.
- [ecphp/cas-bundle](https://github.com/ecphp/cas-bundle) ([2.3.2](https://github.com/ecphp/cas-bundle/releases/tag/2.3.2), 6 days ago) - CAS Bundle, a standard Symfony bundle for authentication using CAS protocol.
